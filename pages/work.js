  ...
  return (
          <main>
            ...
            <div style={{paddingLeft:"2%"}}>
              <br></br>
              <h2 >Company</h2>
              <div className={Styles.cardOuterDiv} style={{gridTemplateColumns : `${!props.mobileView ? '50% 50%' : ''}` , gridGap:`${props.mobileView ? '12%' : ''}` }}>
            ...
            <div style={{paddingLeft:"2%", paddingTop:"6%" ,paddingBottom:"5%"}}>
              <h2 >Projects</h2>
              <br></br>
              <div className={Styles.cardOuterDiv} style={{gridTemplateColumns : `${!props.mobileView ? '30% 30% 30%' : ''}` , gridGap:`${props.mobileView ? '6%' : '6%'}` }}>
